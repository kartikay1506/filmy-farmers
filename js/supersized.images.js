			jQuery(function($){
				...
				$.supersized({
					...
					slides 					:  	[			// Slideshow Images
														...
														{image : './images/slider/slider2.jpg', title : 'Parallax Background <div class="slidedescription">Integer malesuada massa nec arcu porttitor mattis dapibus nisi elementum. Integer tincidunt imperdiet elit nec dapibus. Sed sed tortor in justo porttitor placerat vitae sed nibh. Phasellus interdum feugiat consequat. Nam iaculis dui vitae arcu adipiscing sagittis vehicula augue imperdiet.</div>', thumb : '', url : 'http://themes.tvda.eu/'},
